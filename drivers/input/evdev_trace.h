#ifdef VENDOR_EDIT
#undef TRACE_SYSTEM
#define TRACE_SYSTEM evdev_trace

#if !defined(_TRACE_EVDEV_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_EVDEV_H
...
#endif /* !defined(_TRACE_EVDEV_H) || defined(TRACE_HEADER_MULTI_READ) */

/* This part must be outside protection */
#undef TRACE_INCLUDE_PATH
#define TRACE_INCLUDE_PATH .
#define TRACE_INCLUDE_FILE evdev_trace
